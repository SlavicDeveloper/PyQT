...
from descriptors import PortValidation
from metaclasses import ServerCheck
from server_database import ServerStorage
from PyQt5.QtWidgets import QApplication, QMessageBox
from PyQt5.QtCore import QTimer
from server_gui import MainWindow, gui_model_create, HistoryWindow, history_message_model, ConfigWindow
...
def main():
    ...
    main_window.active_clients_table.setModel(gui_model_create(database))
    ...
    def show_statistics():
        ...
        stat_window.history_table.setModel(history_message_model(database))
